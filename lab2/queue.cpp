...
void test_strategy(const string& strategy_name, size_t (*strategy_func)(size_t), size_t max_elements) {
    vector<int> array;
...
int main() {
    ...
    //test_strategy("Add one", strategy_add_one, max_elements);
    //test_strategy("Fixed chunk", strategy_fixed_chunk, max_elements);
    test_strategy("Multiplicative", strategy_multiplicative, max_elements);
}